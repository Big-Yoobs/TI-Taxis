//scrutil.c made by Baltasarq (https://github.com/Baltasarq/cscrutil/)
...
//scrBlack, scrBlue, scrRed, scrMagenta, scrGreen, scrCyan, scrYellow, scrWhite, scrUndefinedColor
...
{
    char buffer[ 1 ]; //used to have [width + 1] didnt work for some reason
